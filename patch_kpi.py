...
with open("convex/features/reports/kpiAnalytics.ts", "r") as f:
    content = f.read()
...
content = content.replace('import { normalizeItemName } from "../../shared/helpers";', 
...
with open("convex/features/reports/kpiAnalytics.ts", "w") as f:
    f.write(content)
